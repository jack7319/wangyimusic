...
public class EncryptTools {
    ...
    public static String getCommonts(String songId) throws Exception {
        //私钥，随机16位字符串（自己可改）
        ...
        Document document = Jsoup.connect("http://music.163.com/weapi/v1/resource/comments/R_SO_4_" + songId + "/").proxy("",1).cookie("appver", "1.5.0.75771")
    ...
    public static void main(String[] args) throws Exception {
        ...
        String commonts = getCommonts("191210");
        System.out.println(commonts);
        Matcher matcher = pattern.matcher(commonts);
//        if (matcher.matches()){
